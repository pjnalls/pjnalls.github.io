try{
var Xo=Object.defineProperty;var w=(r,e)=>()=>(r&&(e=r(r=0)),e);var Vt=(r,e)=>{for(var t in e)Xo(r,t,{get:e[t],enumerable:!0})};var d=w(()=>{});var p=w(()=>{});var h=w(()=>{});var Xi,qi,Ki,Zt,Ji,Qi,es,ts,rs,os,ns,is,ss,as,Gt,ls,cs,us,ds,ps,hs,fs,ms,Me,gs,Te,vs,ys,re,bs,xs,_s,ws,I,$s,Ss,Es,Xt,As,ks,Cs,Ps,Ms,Ts,Os,Ns,Rs,Bs,js,qt,Ls,Is,Hs,Fs,Us,zs,Ds,Vs,Ys,Ws,Zs,Gs,Xs,qs,Ks,Js,Qs,U=w(()=>{d();p();h();Xi=__STORYBOOKCOMPONENTS__,{A:qi,ActionBar:Ki,AddonPanel:Zt,Badge:Ji,Bar:Qi,Blockquote:es,Button:ts,ClipboardCode:rs,Code:os,DL:ns,Div:is,DocumentWrapper:ss,ErrorFormatter:as,FlexBar:Gt,Form:ls,H1:cs,H2:us,H3:ds,H4:ps,H5:hs,H6:fs,HR:ms,IconButton:Me,IconButtonSkeleton:gs,Icons:Te,Img:vs,LI:ys,Link:re,ListItem:bs,Loader:xs,OL:_s,P:ws,Placeholder:I,Pre:$s,ResetWrapper:Ss,ScrollArea:Es,Separator:Xt,Spaced:As,Span:ks,StorybookIcon:Cs,StorybookLogo:Ps,Symbols:Ms,SyntaxHighlighter:Ts,TT:Os,TabBar:Ns,TabButton:Rs,TabWrapper:Bs,Table:js,Tabs:qt,TabsState:Ls,TooltipLinkList:Is,TooltipMessage:Hs,TooltipNote:Fs,UL:Us,WithTooltip:zs,WithTooltipPure:Ds,Zoom:Vs,codeCommon:Ys,components:Ws,createCopyToClipboardFunction:Zs,getStoryHref:Gs,icons:Xs,interleaveSeparators:qs,nameSpaceClassNames:Ks,resetComponents:Js,withReset:Qs}=__STORYBOOKCOMPONENTS__});var na,ia,sa,aa,la,ca,ua,da,pa,ha,fa,ma,O,ga,va,ya,ba,f,xa,_a,wa,$a,Sa,Ea,Aa,L=w(()=>{d();p();h();na=__STORYBOOKTHEMING__,{CacheProvider:ia,ClassNames:sa,Global:aa,ThemeProvider:la,background:ca,color:ua,convert:da,create:pa,createCache:ha,createGlobal:fa,createReset:ma,css:O,darken:ga,ensure:va,ignoreSsrWarning:ya,isPropValid:ba,jsx:f,keyframes:xa,lighten:_a,styled:wa,themes:$a,typography:Sa,useTheme:Ea,withTheme:Aa}=__STORYBOOKTHEMING__});var Ne={};Vt(Ne,{Children:()=>Ko,Component:()=>et,Fragment:()=>E,Profiler:()=>Jo,PureComponent:()=>Qo,StrictMode:()=>en,Suspense:()=>tt,__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:()=>tn,cloneElement:()=>rn,createContext:()=>on,createElement:()=>nn,createFactory:()=>sn,createRef:()=>an,default:()=>qo,forwardRef:()=>ln,isValidElement:()=>cn,lazy:()=>rt,memo:()=>un,useCallback:()=>H,useContext:()=>dn,useDebugValue:()=>pn,useEffect:()=>N,useImperativeHandle:()=>hn,useLayoutEffect:()=>fn,useMemo:()=>W,useReducer:()=>mn,useRef:()=>gn,useState:()=>M,version:()=>vn});var qo,Ko,et,E,Jo,Qo,en,tt,tn,rn,on,nn,sn,an,ln,cn,rt,un,H,dn,pn,N,hn,fn,W,mn,gn,M,vn,R=w(()=>{d();p();h();qo=__REACT__,{Children:Ko,Component:et,Fragment:E,Profiler:Jo,PureComponent:Qo,StrictMode:en,Suspense:tt,__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:tn,cloneElement:rn,createContext:on,createElement:nn,createFactory:sn,createRef:an,forwardRef:ln,isValidElement:cn,lazy:rt,memo:un,useCallback:H,useContext:dn,useDebugValue:pn,useEffect:N,useImperativeHandle:hn,useLayoutEffect:fn,useMemo:W,useReducer:mn,useRef:gn,useState:M,version:vn}=__REACT__});var nt,ce,bn,xn,_n,Kt,Jt,Qt,Re=w(()=>{d();p();h();R();L();U();nt=function(r,e){return Object.defineProperty?Object.defineProperty(r,"raw",{value:e}):r.raw=e,r},ce=function(r){var e=r.config,t=r.defer,o=t===void 0?!1:t,n=M(o?void 0:e.url),i=n[0],s=n[1],c=M(!1),a=c[0],l=c[1];return N(function(){if(o){var u=requestAnimationFrame(function(){s(e.url)});return function(){return cancelAnimationFrame(u)}}},[o,e.url]),N(function(){l(!1)},[i]),f("div",{css:bn},!a&&f(I,{css:xn},"Loading..."),f("iframe",{css:_n,src:i,allowFullScreen:e.allowFullscreen,onLoad:function(){return l(!0)}}))},bn=O(Kt||(Kt=nt([`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`+e.id,i=ao.get(n);return i||(i=Qr(r.absoluteBoundingBox,e.absoluteBoundingBox),ao.set(n,i)),[...i.map(s=>Un({guide:s,reverseScale:t})),...i.map(s=>zn({guide:s,reverseScale:t,fontSize:o}))]},co=B`
  .distance-line {
    shape-rendering: geometricPrecision;
    fill: none;
    opacity: 0;
...
`});var Kn,So,Eo,Ao=w(()=>{d();p();h();Kn=[{gte:31536e6,divisor:31536e6,unit:"year"},{gte:2592e6,divisor:2592e6,unit:"month"},{gte:6048e5,divisor:6048e5,unit:"week"},{gte:864e5,divisor:864e5,unit:"day"},{gte:36e5,divisor:36e5,unit:"hour"},{gte:6e4,divisor:6e4,unit:"minute"},{gte:3e4,divisor:1e3,unit:"seconds"},{gte:0,divisor:1,text:"just now"}],So=r=>(typeof r=="object"?r:new Date(r)).getTime(),Eo=(r,e=Date.now(),t=new Intl.RelativeTimeFormat(void 0,{numeric:"auto"}))=>{let n=So(e)-So(r),i=Math.abs(n);for(let s of Kn)if(i>=s.gte){let c=Math.round(Math.abs(n)/s.divisor),a=n<0,l=s.unit;return l?t.format(a?c:-c,l):s.text}}});var ko,Co,Po=w(()=>{d();p();h();D();Tt();Ao();ko=B`
  .figma-footer {
    flex: 0;
    z-index: calc(var(--z-index) + 1);
...
`],[`
  ...
  border-radius: 1px;
  box-shadow: 0px 0px 5px rgba(0, 0, 0, 0.15);
`]))),cr,ur,dr;d();p();h();L();U();var Cn=function(r,e){return Object.defineProperty?Object.defineProperty(r,"raw",{value:e}):r.raw=e,r},fr=function(r){var e,t,o,n=r.config;return f("div",{css:Pn},f(re,{cancel:!1,href:n.url,target:(e=n.target)!==null&&e!==void 0?e:"_blank",rel:(t=n.rel)!==null&&t!==void 0?t:"noopener",withArrow:(o=n.showArrow)!==null&&o!==void 0?o:!0},n.label||n.url))};var Pn=O(hr||(hr=Cn([`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
