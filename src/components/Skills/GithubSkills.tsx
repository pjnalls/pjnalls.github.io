export default function GithubSkills() {
  return (
    <>
      <div style={{ margin: '0 auto', textAlign: 'center' }}>
        ...
        <p>
          <a
            ...
            href='https://github.com/SAWARATSUKI/KawaiiLogos/blob/main/README_EN.md'
          >
            KawaiiLogos
          </a>{' '}
          shown above were made by{' '}
          <a
            className='anchor-text'
      ...
      <h3 style={{ textAlign: 'center' }}>🧬 Primary Programming Languages</h3>
      <br />
      <div style={{ margin: '0 auto', textAlign: 'center' }}>
        <img
      ...
      <div style={{ margin: '0 auto', textAlign: 'center' }}>
        ...
        />{' '}
        <img
          src='https://img.shields.io/badge/Mandarin_(Traditional)-801f48'
          alt='Natural Language 3'
        />{' '}
        <img
          src='https://img.shields.io/badge/Japanese-701858'
      ...
      <div style={{ margin: '0 auto', textAlign: 'center' }}>
        ...
        <img
          src='https://github-readme-stats-sigma-five.vercel.app/api/top-langs?username=pjnalls&theme=tokyonight&show_icons=true&hide_title=true&card_width=360&bg_color=0,3f203f,160020&text_color=ffffff&hide_border=true&hide=css,html,javascript'
          alt='Most Used Programming Language on GitHub'
        />
      </div>
    </>
  );
