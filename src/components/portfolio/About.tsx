      ...
      <div className="max-w-[1000px] w-full h-[100%] mx-auto p-2 px-0 py-36 flex justify-center items-center">
        <div className="col-span-2">
          ...
          <p className="py-2 text-black dark:text-white">
            ...
            currently focused on Astro, React, Next.js, Angular (mainly), and
            Tailwind CSS front-end libraries and frameworks.
            <br />
            ...
            <br />
            <br />
            Work as a UI consultant and for my own personal projects feels like
