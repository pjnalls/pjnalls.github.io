...
description: "A blog post about 3 personal areas of frontend/software-engineering weaknesses to play to in 2023 by pjnalls"
pubDate: "Dec 4 2022"
...
## "Play[ing] to my weaknesses" as an frontend developer as a specialist and a software engineer as a generalist
...
👆 By this section header, I mean the _balance_ of focuses between visuals, efficiency, and extensibility of frontend components I create. It's _so_ easy to fixate on only one of these areas when creating components — having the foresight of a frontend architect for potential maintainability issues as a UI project scales.
